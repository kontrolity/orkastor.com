  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse 55% 50% at 90% 30%, rgba(141,111,222,0.06) 0%, transparent 70%)',
        }}
      />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-5 sm:px-6">
        ...
        >
          ...
          <div
            ...
            style={{
              background:
                'radial-gradient(circle at 100% 0%, rgba(141,111,222,0.07) 0%, transparent 70%)',
            }}
          />
          ...
          >
            <InitialAvatar initials={FEATURED.initials} accent="#8D6FDE" />
            <div>
            ...
            >
              <span className="w-1.5 h-1.5 rounded-full animate-pulse" style={{ background: '#8D6FDE' }} />
