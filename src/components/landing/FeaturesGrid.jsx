  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse 70% 60% at 50% -10%, rgba(141,111,222,0.09) 0%, rgba(14,165,233,0.04) 50%, transparent 70%)',
        }}
      />
      ...
      <div
        ...
        style={{
          backgroundImage:
            'radial-gradient(rgba(141,111,222,0.06) 1px, transparent 1px)',
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-5 sm:px-6">
        ...
        >
          <span
            ...
            style={{
              border: '1px solid rgba(141,111,222,0.25)',
              color: 'rgba(167,139,250,0.7)',
              background: 'rgba(141,111,222,0.06)',
            }}
          >
            KubēGraf Features
          </span>
        ...
        >
          ...
          <BentoCard className="col-span-12 md:col-span-7">
            <IconBadge icon={Lock} color="#8D6FDE" />
            ...
            <div
              ...
              style={{
                border: '1px solid rgba(141,111,222,0.22)',
                background: 'rgba(141,111,222,0.06)',
                color: '#A78BFA',
              }}
            >
          ...
          <div className="col-span-12 md:col-span-5 flex flex-col gap-4">
            ...
            >
              <div
                ...
                style={{
                  background: 'linear-gradient(135deg, #8D6FDE, #A78BFA)',
          ...
          <BentoCard className="col-span-12 md:col-span-5">
            <IconBadge icon={Shield} color="#8D6FDE" />
          ...
          <BentoCard className="col-span-12 md:col-span-7">
            ...
            >
              {[
                { label: 'Deploy v2.3.1',     conf: '94%', color: '#8D6FDE' },
          ...
          <BentoCard className="col-span-12 md:col-span-4">
            <IconBadge icon={CheckCircle2} color="#8D6FDE" />
          ...
          <BentoCard className="col-span-12 md:col-span-4">
            <IconBadge icon={Server} color="#8D6FDE" />
