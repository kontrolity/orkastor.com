  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse 70% 60% at 50% -5%, rgba(119,72,246,0.12) 0%, rgba(14,165,233,0.04) 45%, transparent 65%)',
        }}
      />
      ...
      <div
        ...
        style={{
          backgroundImage: 'radial-gradient(rgba(119,72,246,0.07) 1px, transparent 1px)',
          ...
          {!submitted ? (
            <form onSubmit={handleSubmit} className="flex flex-col gap-3 mb-6">
              <input
                ...
                onFocus={e => {
                  e.target.style.borderColor = 'rgba(119,72,246,0.5)';
          ...
          <div className="flex flex-wrap justify-center gap-x-5 gap-y-1.5 mb-10">
            {[
              ...
              <span key={p} className="flex items-center gap-1.5 text-slate-600 text-xs">
                <CheckCircle2 className="w-3.5 h-3.5" style={{ color: '#7748F6' }} />
                {p}
              </span>
            ))}
          </div>
        ...
        >
          <div className="flex justify-center">
            ...
            >
              ...
              <span style={{ color: '#7748F6' }}>orkastor init</span>
            </div>
          </div>
        </motion.div>
