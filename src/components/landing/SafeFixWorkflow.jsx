...
const MODES = [
  ...
  { label: 'Suggest & Approve',   desc: 'AI proposes fixes, you click to apply',       color: '#7748F6' },
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse 60% 55% at 80% 10%, rgba(119,72,246,0.07) 0%, transparent 70%)',
        }}
      />
        ...
        >
          <span
            ...
            style={{
              ...
              color: 'rgba(119,72,246,0.6)',
              background: 'rgba(119,72,246,0.04)',
            }}
          >
            SafeFix Workflow
          </span>
            ...
            <div className="flex items-center gap-2 pt-1 pl-1">
              {STEPS.map(s => (
                <button
                  ...
                  style={{
                    background: activeStep === s.id ? '#7748F6' : 'rgba(255,255,255,0.15)',
