    ...
    <div className="min-h-screen" style={{ backgroundColor: '#050505' }}>
      ...
      <main className="relative">
        <section className="max-w-3xl mx-auto px-5 sm:px-6 pt-36 pb-24">
          ...
          <div className="space-y-10 text-sm leading-relaxed" style={{ color: '#9B93C4' }}>
            ...
            <div>
              <h2 className="text-white text-base font-semibold mb-3">Your infrastructure data stays in your environment</h2>
              <p>
            ...
            {/* ── This website ── */}
            <div>
              <h2 className="text-white text-base font-semibold mb-3">This website — no tracking, no cookies</h2>
              <p>
            ...
            {/* ── Waitlist / forms ── */}
            <div>
              <h2 className="text-white text-base font-semibold mb-3">Waitlist and contact forms</h2>
              <p>
            ...
            {/* ── Your rights ── */}
            <div>
              <h2 className="text-white text-base font-semibold mb-3">Your rights</h2>
              <p>
            ...
            {/* ── Changes ── */}
            <div>
              <h2 className="text-white text-base font-semibold mb-3">Changes</h2>
